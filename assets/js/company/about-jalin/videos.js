...
for (let i = 0; i < cardVideos.length; i++) {
	cardVideos[i].addEventListener('click', function () {
		...
		playVideo.innerHTML = "<iframe width='560' height='315' src='https://www.youtube.com/embed/" + videoId + "'" + "title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen class='w-full h-auto aspect-video'></iframe>"
