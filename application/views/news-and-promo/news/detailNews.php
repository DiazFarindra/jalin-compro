	...
	<section class="grid grid-cols-12 px-3 xs:px-6 sm:px-10 pt-8 lg:pt-14 w-full justify-center">
		...
		<div class="col-span-12 order-1 md:col-span-9 md:order-2">
			<div class="text-left">
				...
				<div class="flex py-4">
					<button href="#" class="rounded-full flex justify-start px-1 text-secondary w-max text-xs 2xl:text-sm z-10 bg-blue-accent">CSR</button>
					<button href="#" class="rounded-full flex justify-start px-1 text-secondary w-max text-xs 2xl:text-sm z-10 bg-blue-accent">CSR</button>
				</div>
				...
				<div class="w-full mt-7">
					<img src="<?= $post['post_image'] ?>" alt="article" width="1280" height="720" class="w-full h-auto sm:h-auto md:h-[303px] lg:w-3/4 lg:h-[312px] xl:h-[400px] 2xl:h-[481px] 3xl:h-[535px] 4xl:h-[608px] object-cover">
				</div>
